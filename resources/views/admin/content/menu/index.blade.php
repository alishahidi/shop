<x-admin.layout.admin-layout title="پنل ادمین - منو ها">
    <x-slot:tags>
    ...
    <x-admin.sections.breadcrumb>
        ...
        <x-admin.sections.breadcrumb-item active name="منو ها" />
    </x-admin.sections.breadcrumb>
    <div class="main-body-container">
        <x-admin.sections.header-title name="منو ها" />
        <div class="body-content">
            <x-admin.sections.header-button href="{{ route('admin.content.menu.create') }}" name="ساخت منو جدید" />
            <hr class="my-2" />
