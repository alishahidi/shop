<x-admin.layout.admin-layout title="پنل ادمین - ساخت فروش شگفت انگیز جدید">
    <x-admin.sections.breadcrumb>
        ...
        <x-admin.sections.breadcrumb-item href="{{ route('admin.market.discount.common.index') }}" name="فروش شگفت انگیز" />
        <x-admin.sections.breadcrumb-item active name="ساخت فروش شگفت انگیز جدید" />
    </x-admin.sections.breadcrumb>
    <div class="main-body-container">
        <x-admin.sections.header-title name="ساخت فروش شگفت انگیز جدید" />
            ...
            <x-admin.forms.form href="#" method='post'>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <x-admin.inputs.input label="کد کالا" name="category" placeholder="کد کالا" />
                    </div>
                    <div class="col-md-6 mb-3">
