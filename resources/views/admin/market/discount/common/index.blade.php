<x-admin.layout.admin-layout title="پنل ادمین - تخفیف های عمومی">
    <x-slot:tags>
    ...
    <x-admin.sections.breadcrumb>
        ...
        <x-admin.sections.breadcrumb-item active name="تخفیف های عمومی" />
    </x-admin.sections.breadcrumb>
    <div class="main-body-container">
        <x-admin.sections.header-title name="تخفیف های عمومی" />
