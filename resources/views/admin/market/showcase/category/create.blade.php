<x-admin.layout.admin-layout title="پنل ادمین - ساخت دسته بندی جدید">
    <x-admin.sections.breadcrumb>
        ...
        <x-admin.sections.breadcrumb-item href="{{ route('admin.market.showcase.category.index') }}" name="دسته بندی ها" />
        <x-admin.sections.breadcrumb-item active name="ساخت دسته بندی جدید" />
    </x-admin.sections.breadcrumb>
